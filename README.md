...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `186.9µs` | `218.6µs` |
| [Day 2](./src/bin/02.rs) | `102.4ms` | `264.5ms` |
| [Day 3](./src/bin/03.rs) | `89.6µs` | `164.2µs` |
| [Day 4](./src/bin/04.rs) | `270.7µs` | `8.0ms` |
| [Day 5](./src/bin/05.rs) | `12.6ms` | `27.7µs` |
| [Day 6](./src/bin/06.rs) | `298.8µs` | `522.5µs` |
