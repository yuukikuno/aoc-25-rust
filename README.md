...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `166.5µs` | `206.3µs` |
| [Day 2](./src/bin/02.rs) | `102.0ms` | `145.6ms` |
| [Day 3](./src/bin/03.rs) | `86.9µs` | `161.1µs` |
| [Day 4](./src/bin/04.rs) | `257.0µs` | `8.0ms` |
| [Day 5](./src/bin/05.rs) | `12.1ms` | `25.1µs` |
| [Day 6](./src/bin/06.rs) | `291.9µs` | `521.3µs` |
| [Day 7](./src/bin/07.rs) | `19.8µs` | `19.2µs` |
